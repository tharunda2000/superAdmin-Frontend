...
const SideMenue = () => {
  ...
  return (
    <div className='relative flex flex-col h-screen w-60 md:w-70 lg:w-90  bg-gray-100 items-center noto z-10 shadow-lg shadow-blue-200'>
        ...
        <div className='flex mt-10 lg:mt-25 bg-gray-300 p-3 lg:p-6 rounded-lg  lg:gap-3 lg:w-65 shadow-md shadow-blue-200'>
        ...
        {dropdown && <div className='flex flex-col text-sm'>
            ...
            <div 
                className='flex mt-3 mx-5  bg-white p-3 lg:p-6 rounded-lg  lg:gap-3 lg:w-55 cursor-pointer hover:bg-green-200 hover:text-green-800 border-1'
        ...
        <div className='flex mt-2 lg:mt-3 bg-gray-300 p-3 lg:p-6 rounded-lg  lg:gap-3 lg:w-65 shadow-md shadow-blue-200'>
