  ...
  return (
    <div className='flex relative h-20 md:h-30 lg:h-40  bg-gray-200 px-3 lg:px-40 items-center justify-between noto '>
        ...
        <div className="relative me-10">
            <i 
                className="ri-information-2-fill lg:text-3xl cursor-pointer hover:text-green-600"
                onMouseEnter={() => setShowTooltip(true)}
                onMouseLeave={() => setShowTooltip(false)}
            ></i>
            
            {showTooltip && connectionClick && <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-100 z-10 px-3 py-1 rounded-lg bg-gray-700 text-white text-sm ">
            ...
            {showTooltip && userClick && <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-100 z-10 px-3 py-1 rounded-lg bg-gray-700 text-white text-sm ">
            ...
            {showTooltip && securityClick && <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-100 z-10 px-3 py-1 rounded-lg bg-gray-700 text-white text-sm ">
